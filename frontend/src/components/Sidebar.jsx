...
//   ChartBarIcon,
//   DocumentTextIcon,
//   MagnifyingGlassCircleIcon,  // { name: 'Case Management', path: '/cases', icon: ScaleIcon },
//   PencilSquareIcon,
//   ScaleIcon,
//   BookOpenIcon,
//   ClockIcon,
...
//   return (
//     <div
//       className={`bg-white border-r border-slate-200 flex flex-col transition-all duration-300 ease-in-out shadow-sm ${
//         isCollapsed ? 'w-20' : 'w-80'
//       } relative`}
//     >
//       {/* Header */}
//       <div className="px-4 py-3 border-b border-slate-200 relative bg-white">
//         <button
...
//         <div className={`transition-all duration-300 ${isCollapsed ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
//           {!isCollapsed && (
...
//           <span className={`${isCollapsed ? 'hidden' : 'inline ml-2'}`}>New Case Analysis</span>
//         </button>
//       </div>
...
//                   key={item.path}
//                   to={item.path}
//                   className={`group flex items-center ${isCollapsed ? 'justify-center px-2' : 'px-3'} py-2.5 text-sm font-medium rounded-lg transition-all duration-200 ${
//                     active
...
//                     }`} 
//                   />
//                   <span className={`${isCollapsed ? 'hidden' : 'inline'} transition-all duration-200`}>
//                     {item.name}
//                   </span>
//                   {active && !isCollapsed && (
...
//         {/* Role Selection - Only show when expanded */}
//         {!isCollapsed && <RoleSelection />}
        
//         {/* Legal Intelligence - Only show when expanded */}
//         {!isCollapsed && <LegalIntelligence />}
...
//         {/* Quick Tools - Only show when expanded */}
//         {!isCollapsed && <QuickTools />}
//       </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-4">
        ...
        {/* Role Selection */}
        <RoleSelection isCollapsed={isCollapsed} />
        
        {/* Legal Intelligence */}
        <LegalIntelligence isCollapsed={isCollapsed} />
        ...
        {/* Quick Tools */}
        <QuickTools isCollapsed={isCollapsed} />
      </div>
